...
public class MadQuiz1 {
  public void lib1() {
    ...
    System.out.println("The coronavirus has taken a toll on everyone, especially " + person + "\n"
        ...
        + "Professor Vanselow seems like a neat guy, he has " + Math.abs(numPlants)
        + " in his garden " + "\n" + "and definetly has " + Math.abs(numType)
        + " different plants");

    String compare =
        numType > numPlants ? "He has more variety of plant" : "He has ALOT of the same Plant";
    System.out.println();
    ...
    while (diverse == true) {
      ...
      break;
      // The break is to stop the loop from becoming an infinite loop and doesnt have a reason to go
    ...
    switch (numPlants) {
      ...
      default:
        ...
        break; 
// This is suppose to take the Random number and to export the assigned phrase. 
    }
